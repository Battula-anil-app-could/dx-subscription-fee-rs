...
use dharitri_sc::api::StorageMapperApi;
use dharitri_sc_modules::ongoing_operation::{LoopOp, CONTINUE_OP, STOP_OP};
    ...
    + dharitri_sc_modules::ongoing_operation::OngoingOperationModule
{
    ...
    fn send_user_rewards(
        ...
        rewards: ManagedVec<DctTokenPayment>,
    ) {
        for rew in &rewards {
            self.send().direct_non_zero_dct_payment(user_address, &rew);
        }
    }
